...
The found postings are checked against it and the ones with a
different work format are left out of the report, so leaving it
empty returns unfiltered jobs.
